...
DATA_DIR = Path(os.environ.get("DOCKUP_DATA", "/app/data"))
STACKS_DIR = Path(os.environ.get("DOCKUP_STACKS", "/opt/stacks"))
MOCK_MODE = os.environ.get("DOCKUP_MOCK") == "1"

DB_PATH = DATA_DIR / "dockup.db"
...
UPDATE_IMAGE = os.environ.get("DOCKUP_UPDATE_IMAGE", "ghcr.io/lightmorphic/dockup:latest")
UPDATE_VERSION_URL = os.environ.get(
    "DOCKUP_UPDATE_VERSION_URL",
    "https://raw.githubusercontent.com/lightmorphic/dockup/main/app/config.py")
